...
int SPI_Init(void)
{
    ...
    IO_DeviceType *spiDev = IO_CreateDevice("spi0", 0, IO_DEVICE_CLASS_UNKNOWN);
    IO_AttachDevice(spiDev, spiBusDriver);

    spiDev = IO_CreateDevice("spi1", 0, IO_DEVICE_CLASS_UNKNOWN);
    IO_AttachDevice(spiDev, spiBusDriver);
...
int FLASH_Init(void)
{
    ...
    IO_DeviceType *nandDev = IO_CreateDevice("nand0", 0, IO_DEVICE_CLASS_UNKNOWN);
    ...
    nandDev = IO_CreateDevice("nand1", 0, IO_DEVICE_CLASS_UNKNOWN);
    IO_AttachDevice(nandDev, flashDriver);
